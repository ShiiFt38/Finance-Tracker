      ...
      <div className="bg-white p-8 rounded-lg shadow-lg w-96">
        ...
        <form>
          ...
          <div className='flex flex-row w-full place-content-end gap-5'>
            ...
            <div className="text-right">
              <button type="submit" onClick={(e) => {e.preventDefault()}}className={`${accentColor} text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none focus:bg-blue-600`}>Add</button>
            </div>
          </div>
